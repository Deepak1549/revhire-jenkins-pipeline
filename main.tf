...
resource "aws_codecommit_repository" "revhire-user-repository" {
  repository_name = "revhire-user-repository-final-projectp2"
...
data "aws_codecommit_repository" "revhire-user-repository" {
  repository_name = aws_codecommit_repository.revhire-user-repository-final-projectp2.repository_name
}

resource "aws_iam_role_policy" "codebuild_policy-final-projectp2" {
